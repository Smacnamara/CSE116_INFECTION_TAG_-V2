...
class MainHandler(tornado.web.RequestHandler):    # these classes define what is done at what path on the server
    def get(self):
        self.write("hello world")

class homeHandler(tornado.web.RequestHandler):
    def get(self):
        self.render(r'src\View\JS\TitleScene.js')

class gameHandler(tornado.web.RequestHandler):
    def get(self):
        self.render(r'src\View\JS\GameScene.js')
...
settings = {
    "template_path": r"src\View\JS",
    "static_path": r"src\View\JS"
}
